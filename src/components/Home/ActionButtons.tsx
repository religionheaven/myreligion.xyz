...
export function ActionButtons({
  ...
  return (
    <>
      ...
      <div
        className={`absolute bottom-32 left-1/2 transform -translate-x-1/2 z-20 hidden md:block transition-opacity duration-300 ${showConfessions ? "opacity-0 pointer-events-none" : "opacity-100"}`}
      >
        <button
      ...
      {/* Live Chat Button */}
      <div
        className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 transition-opacity duration-300 ${showConfessions ? "opacity-0 pointer-events-none" : "opacity-100"}`}
      >
        <button
      ...
      <div
        className={`absolute bottom-8 left-8 z-20 transition-opacity duration-300 ${showConfessions ? "opacity-0 pointer-events-none" : "opacity-100"}`}
      >
