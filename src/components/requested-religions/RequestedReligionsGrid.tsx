...
import { RequestedReligionCard } from "./RequestedReligionCard";

interface RequestedReligionsGridProps {
...
export function RequestedReligionsGrid({
  onReligionClick,
  getClickCount,
