...
export function HomeButtons({
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[240px] lg:-translate-y-[280px] xl:-translate-y-[320px] 2xl:-translate-y-[360px] z-20 hidden md:block transition-opacity duration-300 ${
